...
class graphing_multiple(gp.graphing_multiple):
    ...
    def data_placeholder(self):
        ...
        self.yv3 = zeros(self.N)
        self.yv4 = zeros(self.N)
    ...
    def set_plots(self):
        ...
        self.p021, = self.ax02.plot(self.x02, self.yv1, 'y-', lw=0.2)
        self.p022, = self.ax02.plot(self.x02, self.yv2, 'g-', lw=0.2)
        self.p023, = self.ax02.plot(self.x02, self.yv3, 'r-', lw=0.7)
        self.p024, = self.ax02.plot(self.x02, self.yv4, 'b-', lw=0.5)
